...
dataframe = pd.read_csv('C:/Users/vtush/Desktop/Project Credit Card/code/creditcard1.csv', low_memory=False)
...
#Scoring
print("Using Logistivc Regression the Accuracy Score is: ", logistic.score(X_test, y_test))
